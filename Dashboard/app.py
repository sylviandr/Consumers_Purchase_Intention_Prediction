...
def result():
    if request.method == 'POST':
        ...
        if prediction < 0.5:
            result = "This visitor is predicted not to purchase! Let's give them an offering/sales to seal the deal!"
        else:
            result = "This visitor is predicted to purchase! Awesome!"
